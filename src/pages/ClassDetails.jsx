  ...
  return (
    <div className="container">
      <div className="flex flex-col items-center justify-center">
        ...
        <div>
          <p className="text-3xl mt-3 text-green-400 font-['Roboto-Regular']">Schedule</p>
          <div className="flex gap-[90px] ">
            <p className="text-green-400 font-['Roboto-Regular']">{details?.classDay}</p>
            <p className="text-green-400 font-['Roboto-Regular']">{details?.classTime}</p>
          </div>
        </div>
        <div>
          <p className="mt-5 text-green-400 font-['Roboto-Regular'] ">{details?.classDescription}</p>
        </div>

        <div className="flex justify-between">
          <div className="flex flex-col">
            <p className="text-3xl mt-12 text-green-400 font-['Roboto-Regular']">Trainer</p>
